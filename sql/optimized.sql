...
CREATE TABLE `catalog_category_product_index` (
  ...
  `is_parent` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Parent',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Store ID',
...
CREATE TABLE `catalog_eav_attribute` (
  ...
  `is_global` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Is Global',
  `is_visible` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Is Visible',
  `is_searchable` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Searchable',
  `is_filterable` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Filterable',
  `is_comparable` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Comparable',
  `is_visible_on_front` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Visible On Front',
  `is_html_allowed_on_front` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is HTML Allowed On Front',
  `is_used_for_price_rules` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Used For Price Rules',
  `is_filterable_in_search` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Filterable In Search',
  `used_in_product_listing` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Used In Product Listing',
  `used_for_sort_by` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Used For Sorting',
  `apply_to` varchar(255) DEFAULT NULL COMMENT 'Apply To',
  `is_visible_in_advanced_search` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Visible In Advanced Search',
  `position` int(11) NOT NULL DEFAULT 0 COMMENT 'Position',
  `is_wysiwyg_enabled` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is WYSIWYG Enabled',
  `is_used_for_promo_rules` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Used For Promo Rules',
  `is_required_in_admin_store` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Required In Admin Store',
  `is_used_in_grid` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Used in Grid',
  `is_visible_in_grid` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Visible in Grid',
  `is_filterable_in_grid` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Filterable in Grid',
...
CREATE TABLE `catalog_product_entity_decimal` (
  ...
  `store_id` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Store ID',
  `entity_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Entity ID',
  `value` decimal(12,4) DEFAULT NULL COMMENT 'Optimized Value',
  PRIMARY KEY (`value_id`),
...
CREATE TABLE `catalog_product_index_price` (
  ...
  `price` decimal(7,2) DEFAULT NULL COMMENT 'Price',
  `final_price` decimal(7,2) DEFAULT NULL COMMENT 'Final Price',
  `min_price` decimal(7,2) DEFAULT NULL COMMENT 'Min Price',
  `max_price` decimal(7,2) DEFAULT NULL COMMENT 'Max Price',
  `tier_price` decimal(7,2) DEFAULT NULL COMMENT 'Tier Price',
...
CREATE TABLE `catalog_product_index_price_cfg_opt_agr_idx` (
  ...
  `customer_group_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Price',
  `tier_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Tier Price',
...
CREATE TABLE `catalog_product_index_price_cfg_opt_idx` (
  ...
  `customer_group_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `min_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Min Price',
  `max_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Max Price',
  `tier_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Tier Price',
  PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`)
...
CREATE TABLE `catalog_product_index_price_final_idx` (
  ...
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `tax_class_id` smallint(5) unsigned DEFAULT 0 COMMENT 'Tax Class ID',
  `orig_price` decimal(7,2) DEFAULT NULL COMMENT 'Original Price',
  `price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Price',
  `min_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Min Price',
  `max_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Max Price',
  `tier_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Tier Price',
  `base_tier` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Base Tier',
  PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`)
...
CREATE TABLE `catalog_product_index_price_final_tmp` (
  ...
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `tax_class_id` smallint(5) unsigned DEFAULT 0 COMMENT 'Tax Class ID',
  `orig_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Original Price',
  `price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Price',
  `min_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Min Price',
  `max_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Max Price',
  `tier_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Tier Price',
...
CREATE TABLE `catalog_product_index_price_replica` (
  ...
  `tax_class_id` smallint(5) unsigned DEFAULT 0 COMMENT 'Tax Class ID',
  `price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Price',
  `final_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Final Price',
  `min_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Min Price',
  `max_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Max Price',
  `tier_price` decimal(7,2) DEFAULT NULL COMMENT 'Optimized Tier Price',
  PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
...
CREATE TABLE `catalog_product_option` (
  ...
  `is_require` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Is Required',
...
CREATE TABLE `catalog_product_option_type_price` (
  ...
  `store_id` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Store ID',
  `price` decimal(7,2) NOT NULL DEFAULT 0.00 COMMENT 'Price',
  `price_type` varchar(7) NOT NULL DEFAULT 'fixed' COMMENT 'Price Type',
...
CREATE TABLE `cataloginventory_stock_item` (
  ...
  `qty` decimal(8,2) DEFAULT NULL COMMENT 'Qty',
  `min_qty` decimal(8,2) NOT NULL DEFAULT 0.00 COMMENT 'Min Qty',
  `use_config_min_qty` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Use Config Min Qty',
  `is_qty_decimal` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Qty Decimal',
  `backorders` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Backorders',
  `use_config_backorders` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Use Config Backorders',
  `min_sale_qty` decimal(12,4) NOT NULL DEFAULT 1.0000 COMMENT 'Min Sale Qty',
  `use_config_min_sale_qty` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Use Config Min Sale Qty',
  `max_sale_qty` decimal(12,4) NOT NULL DEFAULT 0.0000 COMMENT 'Max Sale Qty',
  `use_config_max_sale_qty` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Use Config Max Sale Qty',
  `is_in_stock` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is In Stock',
  `low_stock_date` timestamp NULL DEFAULT NULL COMMENT 'Low Stock Date',
  `notify_stock_qty` decimal(12,4) DEFAULT NULL COMMENT 'Notify Stock Qty',
  `use_config_notify_stock_qty` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Use Config Notify Stock Qty',
  `manage_stock` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Manage Stock',
  `use_config_manage_stock` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Use Config Manage Stock',
  `stock_status_changed_auto` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Stock Status Changed Automatically',
  `use_config_qty_increments` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Use Config Qty Increments',
  `qty_increments` decimal(8,2) NOT NULL DEFAULT 0.00 COMMENT 'Qty Increments',
  `use_config_enable_qty_inc` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Use Config Enable Qty Increments',
  `enable_qty_increments` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Enable Qty Increments',
  `is_decimal_divided` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Divided into Multiple Boxes for Shipping',
...
CREATE TABLE `cataloginventory_stock_status_replica` (
  ...
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `stock_id` smallint(5) unsigned NOT NULL COMMENT 'Stock ID',
  `qty` decimal(8,2) NOT NULL DEFAULT 0.00 COMMENT 'Qty',
  `stock_status` tinyint(1) NOT NULL COMMENT 'Stock Status',
  PRIMARY KEY (`product_id`,`website_id`,`stock_id`),
  KEY `CATALOGINVENTORY_STOCK_STATUS_STOCK_ID` (`stock_id`),
  KEY `CATALOGINVENTORY_STOCK_STATUS_WEBSITE_ID` (`website_id`),
  KEY `CATALOGINVENTORY_STOCK_STATUS_STOCK_STATUS` (`stock_status`)
...
CREATE TABLE `customer_address_entity` (
  ...
  `country_id` varchar(32) NOT NULL COMMENT 'Country',
  ...
  `postcode` varchar(10) DEFAULT NULL COMMENT 'Zip/Postal Code',
  `prefix` varchar(10) DEFAULT NULL COMMENT 'Name Prefix',
  `region` varchar(100) DEFAULT NULL COMMENT 'State/Province',
  `region_id` int(10) unsigned DEFAULT NULL COMMENT 'State/Province',
  `street` text NOT NULL COMMENT 'Street Address',
  `suffix` varchar(40) DEFAULT NULL COMMENT 'Name Suffix',
  `telephone` varchar(20) NOT NULL COMMENT 'Phone Number',
  `vat_id` varchar(255) DEFAULT NULL COMMENT 'VAT number',
  `vat_is_valid` tinyint(1) DEFAULT NULL COMMENT 'Vat Is Valid',
  `vat_request_date` varchar(255) DEFAULT NULL COMMENT 'VAT number validation request date',
  `vat_request_id` varchar(255) DEFAULT NULL COMMENT 'VAT number validation request ID',
  `vat_request_success` tinyint(1) DEFAULT NULL COMMENT 'Vat Request Success',
  PRIMARY KEY (`entity_id`),
...
CREATE TABLE `customer_eav_attribute` (
  ...
  `multiline_count` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Multiline Count',
  ...
  `is_visible_in_grid` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Visible in Grid',
  `is_filterable_in_grid` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Filterable in Grid',
  `is_searchable_in_grid` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Searchable in Grid',
  `grid_filter_condition_type` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Grid Filter Condition Type',
  PRIMARY KEY (`attribute_id`),
...
CREATE TABLE `customer_eav_attribute_website` (
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `is_visible` tinyint(1) DEFAULT NULL COMMENT 'Is Visible',
  `is_required` tinyint(1) DEFAULT NULL COMMENT 'Is Required',
...
CREATE TABLE `customer_entity` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Updated At',
  `is_active` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Is Active',
  `disable_auto_group_change` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Disable automatic group change based on VAT ID',
  `created_in` varchar(50) DEFAULT NULL COMMENT 'Created From',
  `prefix` varchar(10) DEFAULT NULL COMMENT 'Name Prefix',
  `firstname` varchar(50) DEFAULT NULL COMMENT 'First Name',
  `middlename` varchar(50) DEFAULT NULL COMMENT 'Middle Name/Initial',
...
CREATE TABLE `directory_currency_rate` (
  ...
  `rate` decimal(9,6) NOT NULL DEFAULT 0.000000 COMMENT 'Currency Conversion Rate',
...
CREATE TABLE `eav_attribute` (
  ...
  `is_required` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Defines Is Required',
  `is_user_defined` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Defines Is User Defined',
  `default_value` text DEFAULT NULL COMMENT 'Default Value',
  `is_unique` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Defines Is Unique',
...
CREATE TABLE `eav_entity` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Updated At',
  `is_active` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Defines Is Entity Active',
  PRIMARY KEY (`entity_id`),
...
CREATE TABLE `eav_entity_type` (
  ...
  `is_data_sharing` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Defines Is Data Sharing',
  `data_sharing_key` varchar(100) DEFAULT 'default' COMMENT 'Data Sharing Key',
  `default_attribute_set_id` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Default Attribute Set ID',
  `increment_model` varchar(255) DEFAULT NULL COMMENT 'Increment Model',
  `increment_per_store` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Increment Per Store',
...
CREATE TABLE `quote` (
  ...
  `is_virtual` tinyint(1) DEFAULT 0 COMMENT 'Is Virtual',
  `is_multi_shipping` tinyint(1) DEFAULT 0 COMMENT 'Is Multi Shipping',
  `items_count` int(10) unsigned DEFAULT 0 COMMENT 'Items Count',
  `items_qty` decimal(12,2) DEFAULT 0.00 COMMENT 'Items Qty',
  `orig_order_id` int(10) unsigned DEFAULT 0 COMMENT 'Orig Order ID',
  `store_to_base_rate` decimal(12,2) DEFAULT 0.00 COMMENT 'Store To Base Rate',
  `store_to_quote_rate` decimal(12,2) DEFAULT 0.00 COMMENT 'Store To Quote Rate',
  `base_currency_code` varchar(3) DEFAULT NULL COMMENT 'Base Currency Code',
  `store_currency_code` varchar(3) DEFAULT NULL COMMENT 'Store Currency Code',
  `quote_currency_code` varchar(3) DEFAULT NULL COMMENT 'Quote Currency Code',
  `grand_total` decimal(12,2) DEFAULT 0.00 COMMENT 'Grand Total',
  `base_grand_total` decimal(12,2) DEFAULT 0.00 COMMENT 'Base Grand Total',
  `checkout_method` varchar(255) DEFAULT NULL COMMENT 'Checkout Method',
  `customer_id` int(10) unsigned DEFAULT NULL COMMENT 'Customer ID',
  `customer_tax_class_id` int(10) unsigned DEFAULT NULL COMMENT 'Customer Tax Class ID',
  `customer_group_id` int(10) unsigned DEFAULT 0 COMMENT 'Customer Group ID',
  `customer_email` varchar(128) DEFAULT NULL COMMENT 'Customer Email',
  `customer_prefix` varchar(10) DEFAULT NULL COMMENT 'Customer Prefix',
  `customer_firstname` varchar(50) DEFAULT NULL COMMENT 'Customer Firstname',
  `customer_middlename` varchar(40) DEFAULT NULL COMMENT 'Customer Middlename',
  `customer_lastname` varchar(50) DEFAULT NULL COMMENT 'Customer Lastname',
  `customer_suffix` varchar(10) DEFAULT NULL COMMENT 'Customer Suffix',
  `customer_dob` datetime DEFAULT NULL COMMENT 'Customer Dob',
  `customer_note` text DEFAULT NULL COMMENT 'Customer Note',
  `customer_note_notify` tinyint(1) DEFAULT 1 COMMENT 'Customer Note Notify',
  `customer_is_guest` tinyint(1) DEFAULT 0 COMMENT 'Customer Is Guest',
  ...
  `base_to_global_rate` decimal(12,2) DEFAULT NULL COMMENT 'Base To Global Rate',
  `base_to_quote_rate` decimal(12,2) DEFAULT NULL COMMENT 'Base To Quote Rate',
  `customer_taxvat` varchar(20) DEFAULT NULL COMMENT 'Customer Taxvat',
  `customer_gender` varchar(20) DEFAULT NULL COMMENT 'Customer Gender',
  `subtotal` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal',
  `base_subtotal` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal',
  `subtotal_with_discount` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal With Discount',
  `base_subtotal_with_discount` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal With Discount',
  `is_changed` tinyint(1) DEFAULT 0 COMMENT 'Is Changed',
  `trigger_recollect` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Trigger Recollect',
...
CREATE TABLE `quote_address` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Updated At',
  `customer_id` int(10) unsigned DEFAULT NULL COMMENT 'Customer ID',
  `save_in_address_book` tinyint(1) DEFAULT 0 COMMENT 'Save In Address Book',
  `customer_address_id` int(10) unsigned DEFAULT NULL COMMENT 'Customer Address ID',
  `address_type` varchar(10) DEFAULT NULL COMMENT 'Address Type',
  `email` varchar(128) DEFAULT NULL COMMENT 'Email',
  `prefix` varchar(10) DEFAULT NULL COMMENT 'Prefix',
  ...
  `same_as_billing` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Same As Billing',
  `collect_shipping_rates` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Collect Shipping Rates',
  `shipping_method` varchar(120) DEFAULT NULL,
  `shipping_description` varchar(255) DEFAULT NULL COMMENT 'Shipping Description',
  `weight` decimal(7,2) NOT NULL DEFAULT 0.00 COMMENT 'Weight',
  `subtotal` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Subtotal',
  `base_subtotal` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Subtotal',
  `subtotal_with_discount` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Subtotal With Discount',
  `base_subtotal_with_discount` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Subtotal With Discount',
  `tax_amount` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Tax Amount',
  `base_tax_amount` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Tax Amount',
  `shipping_amount` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Shipping Amount',
  `base_shipping_amount` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Shipping Amount',
  `shipping_tax_amount` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Tax Amount',
  `base_shipping_tax_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Tax Amount',
  `discount_amount` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Discount Amount',
  `base_discount_amount` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Discount Amount',
  `grand_total` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Grand Total',
  `base_grand_total` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Grand Total',
  ...
  `shipping_discount_amount` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Discount Amount',
  `base_shipping_discount_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Discount Amount',
  `subtotal_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal Incl Tax',
  `base_subtotal_total_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal Total Incl Tax',
  `discount_tax_compensation_amount` decimal(12,2) DEFAULT NULL COMMENT 'Discount Tax Compensation Amount',
  `base_discount_tax_compensation_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Discount Tax Compensation Amount',
  `shipping_discount_tax_compensation_amount` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Discount Tax Compensation Amount',
  `base_shipping_discount_tax_compensation_amnt` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Discount Tax Compensation Amount',
  `shipping_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Incl Tax',
  `base_shipping_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Incl Tax',
  `vat_id` varchar(255) DEFAULT NULL COMMENT 'Vat ID',
  `vat_is_valid` tinyint(1) DEFAULT NULL COMMENT 'Vat Is Valid',
  `vat_request_id` varchar(255) DEFAULT NULL COMMENT 'Vat Request ID',
  `vat_request_date` varchar(255) DEFAULT NULL COMMENT 'Vat Request Date',
  `vat_request_success` tinyint(1) DEFAULT NULL COMMENT 'Vat Request Success',
...
CREATE TABLE `quote_address_item` (
  ...
  `weight` decimal(7,2) DEFAULT 0.00 COMMENT 'Weight',
  `qty` decimal(8,2) NOT NULL DEFAULT 0.00 COMMENT 'Qty',
  `discount_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Discount Amount',
  `tax_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Tax Amount',
  `row_total` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Row Total',
  `base_row_total` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Row Total',
  `row_total_with_discount` decimal(12,2) DEFAULT 0.00 COMMENT 'Row Total With Discount',
  `base_discount_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Base Discount Amount',
  `base_tax_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Base Tax Amount',
  `row_weight` decimal(8,2) DEFAULT 0.00 COMMENT 'Row Weight',
  ...
  `name` varchar(255) DEFAULT NULL COMMENT 'Name',
  `description` text DEFAULT NULL COMMENT 'Description',
  `is_qty_decimal` tinyint(1) DEFAULT NULL COMMENT 'Is Qty Decimal',
  `price` decimal(7,2) DEFAULT NULL COMMENT 'Price',
  `discount_percent` decimal(5,2) DEFAULT NULL COMMENT 'Discount Percent',
  `no_discount` int(10) unsigned DEFAULT NULL COMMENT 'No Discount',
  `tax_percent` decimal(5,2) DEFAULT NULL COMMENT 'Tax Percent',
  `base_price` decimal(7,2) DEFAULT NULL COMMENT 'Base Price',
  `base_cost` decimal(7,2) DEFAULT NULL COMMENT 'Base Cost',
  `price_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Price Incl Tax',
  `base_price_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Price Incl Tax',
  `row_total_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Row Total Incl Tax',
  `base_row_total_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Row Total Incl Tax',
  `discount_tax_compensation_amount` decimal(12,2) DEFAULT NULL COMMENT 'Discount Tax Compensation Amount',
  `base_discount_tax_compensation_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Discount Tax Compensation Amount',
  `gift_message_id` int(11) DEFAULT NULL COMMENT 'Gift Message ID',
...
CREATE TABLE `quote_item` (
  ...
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store ID',
  `parent_item_id` int(10) unsigned DEFAULT NULL COMMENT 'Parent Item ID',
  `is_virtual` tinyint(1) DEFAULT NULL COMMENT 'Is Virtual',
  `sku` varchar(64) DEFAULT NULL COMMENT 'Sku',
  `name` varchar(255) DEFAULT NULL COMMENT 'Name',
  `description` text DEFAULT NULL COMMENT 'Description',
  `applied_rule_ids` text DEFAULT NULL COMMENT 'Applied Rule Ids',
  `additional_data` text DEFAULT NULL COMMENT 'Additional Data',
  `is_qty_decimal` tinyint(1) DEFAULT NULL COMMENT 'Is Qty Decimal',
  `no_discount` tinyint(1) DEFAULT 0 COMMENT 'No Discount',
  `weight` decimal(7,2) DEFAULT 0.00 COMMENT 'Weight',
  `qty` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Qty',
  `price` decimal(7,2) NOT NULL DEFAULT 0.00 COMMENT 'Price',
  `base_price` decimal(7,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Price',
  `custom_price` decimal(7,2) DEFAULT NULL COMMENT 'Custom Price',
  `discount_percent` decimal(5,2) DEFAULT 0.00 COMMENT 'Discount Percent',
  `discount_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Discount Amount',
  `base_discount_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Base Discount Amount',
  `tax_percent` decimal(5,2) DEFAULT 0.00 COMMENT 'Tax Percent',
  `tax_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Tax Amount',
  `base_tax_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Base Tax Amount',
  `row_total` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Row Total',
  `base_row_total` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Row Total',
  ...
  `base_tax_before_discount` decimal(7,2) DEFAULT NULL COMMENT 'Base Tax Before Discount',
  `tax_before_discount` decimal(7,2) DEFAULT NULL COMMENT 'Tax Before Discount',
  `original_custom_price` decimal(7,2) DEFAULT NULL COMMENT 'Original Custom Price',
  `redirect_url` varchar(255) DEFAULT NULL COMMENT 'Redirect Url',
  `base_cost` decimal(7,2) DEFAULT NULL COMMENT 'Base Cost',
  `price_incl_tax` decimal(7,2) DEFAULT NULL COMMENT 'Price Incl Tax',
  `base_price_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Price Incl Tax',
  `row_total_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Row Total Incl Tax',
  `base_row_total_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Row Total Incl Tax',
  `discount_tax_compensation_amount` decimal(12,2) DEFAULT NULL COMMENT 'Discount Tax Compensation Amount',
...
CREATE TABLE `sales_creditmemo` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store ID',
  `adjustment_positive` decimal(12,2) DEFAULT NULL COMMENT 'Adjustment Positive',
  `base_shipping_tax_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Tax Amount',
  `store_to_order_rate` decimal(12,2) DEFAULT NULL COMMENT 'Store To Order Rate',
  `base_discount_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Discount Amount',
  `base_to_order_rate` decimal(12,2) DEFAULT NULL COMMENT 'Base To Order Rate',
  `grand_total` decimal(12,2) DEFAULT NULL COMMENT 'Grand Total',
  `base_adjustment_negative` decimal(12,2) DEFAULT NULL COMMENT 'Base Adjustment Negative',
  `base_subtotal_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal Incl Tax',
  `shipping_amount` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Amount',
  `subtotal_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal Incl Tax',
  `adjustment_negative` decimal(12,2) DEFAULT NULL COMMENT 'Adjustment Negative',
  `base_shipping_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Amount',
  `store_to_base_rate` decimal(12,2) DEFAULT NULL COMMENT 'Store To Base Rate',
  `base_to_global_rate` decimal(12,2) DEFAULT NULL COMMENT 'Base To Global Rate',
  `base_adjustment` decimal(12,2) DEFAULT NULL COMMENT 'Base Adjustment',
  `base_subtotal` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal',
  `discount_amount` decimal(12,2) DEFAULT NULL COMMENT 'Discount Amount',
  `subtotal` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal',
  `adjustment` decimal(12,2) DEFAULT NULL COMMENT 'Adjustment',
  `base_grand_total` decimal(12,2) DEFAULT NULL COMMENT 'Base Grand Total',
  `base_adjustment_positive` decimal(12,2) DEFAULT NULL COMMENT 'Base Adjustment Positive',
  `base_tax_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Tax Amount',
  `shipping_tax_amount` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Tax Amount',
  `tax_amount` decimal(12,2) DEFAULT NULL COMMENT 'Tax Amount',
  `order_id` int(10) unsigned NOT NULL COMMENT 'Order ID',
  `email_sent` tinyint(1) DEFAULT NULL COMMENT 'Email Sent',
  `send_email` tinyint(1) DEFAULT NULL COMMENT 'Send Email',
  ...
  `discount_description` varchar(255) DEFAULT NULL COMMENT 'Discount Description',
  `customer_note` text DEFAULT NULL COMMENT 'Customer Note',
  `customer_note_notify` tinyint(1) DEFAULT NULL COMMENT 'Customer Note Notify',
  PRIMARY KEY (`entity_id`),
...
CREATE TABLE `sales_creditmemo_comment` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent ID',
  `is_customer_notified` tinyint(1) DEFAULT NULL COMMENT 'Is Customer Notified',
  `is_visible_on_front` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Is Visible On Front',
...
CREATE TABLE `sales_creditmemo_grid` (
  ...
  `subtotal` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal',
  `shipping_and_handling` decimal(12,2) DEFAULT NULL COMMENT 'Shipping and handling amount',
  `adjustment_positive` decimal(12,2) DEFAULT NULL COMMENT 'Adjustment Positive',
  `adjustment_negative` decimal(12,2) DEFAULT NULL COMMENT 'Adjustment Negative',
  `order_base_grand_total` decimal(12,2) DEFAULT NULL COMMENT 'Order Grand Total',
  PRIMARY KEY (`entity_id`),
...
CREATE TABLE `sales_creditmemo_item` (
  ...
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent ID',
  `base_price` decimal(7,2) DEFAULT NULL COMMENT 'Base Price',
  `tax_amount` decimal(7,2) DEFAULT NULL COMMENT 'Tax Amount',
  `base_row_total` decimal(12,2) DEFAULT NULL COMMENT 'Base Row Total',
  `discount_amount` decimal(7,2) DEFAULT NULL COMMENT 'Discount Amount',
  `row_total` decimal(12,2) DEFAULT NULL COMMENT 'Row Total',
  `base_discount_amount` decimal(7,2) DEFAULT NULL COMMENT 'Base Discount Amount',
  `price_incl_tax` decimal(7,2) DEFAULT NULL COMMENT 'Price Incl Tax',
  `base_tax_amount` decimal(7,2) DEFAULT NULL COMMENT 'Base Tax Amount',
  `base_price_incl_tax` decimal(7,2) DEFAULT NULL COMMENT 'Base Price Incl Tax',
  `qty` decimal(8,2) DEFAULT NULL COMMENT 'Qty',
  `base_cost` decimal(7,2) DEFAULT NULL COMMENT 'Base Cost',
  `price` decimal(7,2) DEFAULT NULL COMMENT 'Price',
  `base_row_total_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Row Total Incl Tax',
...
CREATE TABLE `sales_invoice` (
  ...
  `store_to_base_rate` decimal(12,2) DEFAULT NULL COMMENT 'Store To Base Rate',
  `base_shipping_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Amount',
  `total_qty` decimal(12,2) DEFAULT NULL COMMENT 'Total Qty',
  `base_to_global_rate` decimal(12,2) DEFAULT NULL COMMENT 'Base To Global Rate',
  `subtotal` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal',
  `base_subtotal` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal',
  `discount_amount` decimal(12,2) DEFAULT NULL COMMENT 'Discount Amount',
  `billing_address_id` int(11) DEFAULT NULL COMMENT 'Billing Address ID',
  `is_used_for_refund` tinyint(1) DEFAULT NULL COMMENT 'Is Used For Refund',
  `order_id` int(10) unsigned NOT NULL COMMENT 'Order ID',
  `email_sent` tinyint(1) DEFAULT NULL COMMENT 'Email Sent',
  `send_email` tinyint(1) DEFAULT NULL COMMENT 'Send Email',
  `can_void_flag` tinyint(1) DEFAULT NULL COMMENT 'Can Void Flag',
  `state` int(11) DEFAULT NULL COMMENT 'State',
  `shipping_address_id` int(11) DEFAULT NULL COMMENT 'Shipping Address ID',
  `store_currency_code` varchar(3) DEFAULT NULL COMMENT 'Store Currency Code',
  `transaction_id` varchar(255) DEFAULT NULL COMMENT 'Transaction ID',
  ...
  `shipping_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Incl Tax',
  `base_shipping_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Incl Tax',
  `base_total_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Total Refunded',
  `discount_description` varchar(255) DEFAULT NULL COMMENT 'Discount Description',
  `customer_note` text DEFAULT NULL COMMENT 'Customer Note',
  `customer_note_notify` tinyint(1) DEFAULT NULL COMMENT 'Customer Note Notify',
  PRIMARY KEY (`entity_id`),
...
CREATE TABLE `sales_order` (
  ...
  `customer_id` int(10) unsigned DEFAULT NULL COMMENT 'Customer ID',
  `base_discount_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Discount Amount',
  `base_discount_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Base Discount Canceled',
  `base_discount_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Base Discount Invoiced',
  `base_discount_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Discount Refunded',
  `base_grand_total` decimal(12,2) DEFAULT NULL COMMENT 'Base Grand Total',
  `base_shipping_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Amount',
  `base_shipping_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Canceled',
  `base_shipping_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Invoiced',
  `base_shipping_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Refunded',
  `base_shipping_tax_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Tax Amount',
  `base_shipping_tax_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Tax Refunded',
  `base_subtotal` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal',
  `base_subtotal_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal Canceled',
  `base_subtotal_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal Invoiced',
  `base_subtotal_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal Refunded',
  `base_tax_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Tax Amount',
  `base_tax_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Base Tax Canceled',
  `base_tax_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Base Tax Invoiced',
  `base_tax_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Tax Refunded',
  `base_to_global_rate` decimal(12,2) DEFAULT NULL COMMENT 'Base To Global Rate',
  `base_to_order_rate` decimal(12,2) DEFAULT NULL COMMENT 'Base To Order Rate',
  `base_total_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Base Total Canceled',
  `base_total_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Base Total Invoiced',
  `base_total_invoiced_cost` decimal(12,2) DEFAULT NULL COMMENT 'Base Total Invoiced Cost',
  `base_total_offline_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Total Offline Refunded',
  `base_total_online_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Total Online Refunded',
  `base_total_paid` decimal(12,2) DEFAULT NULL COMMENT 'Base Total Paid',
  `base_total_qty_ordered` decimal(12,2) DEFAULT NULL COMMENT 'Base Total Qty Ordered',
  `base_total_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Total Refunded',
  `discount_amount` decimal(12,2) DEFAULT NULL COMMENT 'Discount Amount',
  `discount_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Discount Canceled',
  `discount_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Discount Invoiced',
  `discount_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Discount Refunded',
  `grand_total` decimal(12,2) DEFAULT NULL COMMENT 'Grand Total',
  `shipping_amount` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Amount',
  `shipping_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Canceled',
  `shipping_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Invoiced',
  `shipping_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Refunded',
  `shipping_tax_amount` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Tax Amount',
  `shipping_tax_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Tax Refunded',
  `store_to_base_rate` decimal(12,2) DEFAULT NULL COMMENT 'Store To Base Rate',
  `store_to_order_rate` decimal(12,2) DEFAULT NULL COMMENT 'Store To Order Rate',
  `subtotal` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal',
  `subtotal_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal Canceled',
  `subtotal_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal Invoiced',
  `subtotal_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal Refunded',
  `tax_amount` decimal(12,2) DEFAULT NULL COMMENT 'Tax Amount',
  `tax_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Tax Canceled',
  `tax_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Tax Invoiced',
  `tax_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Tax Refunded',
  `total_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Total Canceled',
  `total_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Total Invoiced',
  `total_offline_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Total Offline Refunded',
  `total_online_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Total Online Refunded',
  `total_paid` decimal(12,2) DEFAULT NULL COMMENT 'Total Paid',
  `total_qty_ordered` decimal(12,2) DEFAULT NULL COMMENT 'Total Qty Ordered',
  `total_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Total Refunded',
  `can_ship_partially` tinyint(1) DEFAULT NULL COMMENT 'Can Ship Partially',
  `can_ship_partially_item` tinyint(1) DEFAULT NULL COMMENT 'Can Ship Partially Item',
  `customer_is_guest` tinyint(1) DEFAULT NULL COMMENT 'Customer Is Guest',
  `customer_note_notify` tinyint(1) DEFAULT NULL COMMENT 'Customer Note Notify',
  `billing_address_id` int(11) DEFAULT NULL COMMENT 'Billing Address ID',
  `customer_group_id` int(11) DEFAULT NULL,
  ...
  `base_shipping_discount_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Discount Amount',
  `base_subtotal_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Subtotal Incl Tax',
  `base_total_due` decimal(12,2) DEFAULT NULL COMMENT 'Base Total Due',
  `payment_authorization_amount` decimal(12,2) DEFAULT NULL COMMENT 'Payment Authorization Amount',
  `shipping_discount_amount` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Discount Amount',
  `subtotal_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Subtotal Incl Tax',
  `total_due` decimal(12,2) DEFAULT NULL COMMENT 'Total Due',
  `weight` decimal(8,2) DEFAULT NULL COMMENT 'Weight',
  `customer_dob` datetime DEFAULT NULL COMMENT 'Customer Dob',
  `increment_id` varchar(50) DEFAULT NULL COMMENT 'Increment ID',
  ...
  `shipping_discount_tax_compensation_amount` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Discount Tax Compensation Amount',
  `base_shipping_discount_tax_compensation_amnt` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Discount Tax Compensation Amount',
  `discount_tax_compensation_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Discount Tax Compensation Invoiced',
  `base_discount_tax_compensation_invoiced` decimal(12,2) DEFAULT NULL COMMENT 'Base Discount Tax Compensation Invoiced',
  `discount_tax_compensation_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Discount Tax Compensation Refunded',
  `base_discount_tax_compensation_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Discount Tax Compensation Refunded',
  `shipping_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Incl Tax',
  `base_shipping_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Incl Tax',
...
CREATE TABLE `sales_order_item` (
  ...
  `additional_data` text DEFAULT NULL COMMENT 'Additional Data',
  `is_qty_decimal` tinyint(1) DEFAULT NULL COMMENT 'Is Qty Decimal',
  `no_discount` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'No Discount',
  `qty_backordered` decimal(8,2) DEFAULT 0.00 COMMENT 'Qty Backordered',
  `qty_canceled` decimal(8,2) DEFAULT 0.00 COMMENT 'Qty Canceled',
  `qty_invoiced` decimal(8,2) DEFAULT 0.00 COMMENT 'Qty Invoiced',
  `qty_ordered` decimal(8,2) DEFAULT 0.00 COMMENT 'Qty Ordered',
  `qty_refunded` decimal(8,2) DEFAULT 0.00 COMMENT 'Qty Refunded',
  `qty_shipped` decimal(8,2) DEFAULT 0.00 COMMENT 'Qty Shipped',
  `base_cost` decimal(7,2) DEFAULT 0.00 COMMENT 'Base Cost',
  `price` decimal(7,2) NOT NULL DEFAULT 0.00 COMMENT 'Price',
  `base_price` decimal(7,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Price',
  `original_price` decimal(7,2) DEFAULT NULL COMMENT 'Original Price',
  `base_original_price` decimal(7,2) DEFAULT NULL COMMENT 'Base Original Price',
  `tax_percent` decimal(5,2) DEFAULT 0.00 COMMENT 'Tax Percent',
  `tax_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Tax Amount',
  `base_tax_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Base Tax Amount',
  `tax_invoiced` decimal(7,2) DEFAULT 0.00 COMMENT 'Tax Invoiced',
  `base_tax_invoiced` decimal(7,2) DEFAULT 0.00 COMMENT 'Base Tax Invoiced',
  `discount_percent` decimal(5,2) DEFAULT 0.00 COMMENT 'Discount Percent',
  `discount_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Discount Amount',
  `base_discount_amount` decimal(7,2) DEFAULT 0.00 COMMENT 'Base Discount Amount',
  `discount_invoiced` decimal(7,2) DEFAULT 0.00 COMMENT 'Discount Invoiced',
  `base_discount_invoiced` decimal(7,2) DEFAULT 0.00 COMMENT 'Base Discount Invoiced',
  `amount_refunded` decimal(7,2) DEFAULT 0.00 COMMENT 'Amount Refunded',
  `base_amount_refunded` decimal(7,2) DEFAULT 0.00 COMMENT 'Base Amount Refunded',
  `row_total` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Row Total',
  `base_row_total` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Row Total',
  `row_invoiced` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Row Invoiced',
  `base_row_invoiced` decimal(12,2) NOT NULL DEFAULT 0.00 COMMENT 'Base Row Invoiced',
  `row_weight` decimal(8,2) DEFAULT 0.00 COMMENT 'Row Weight',
  `base_tax_before_discount` decimal(7,2) DEFAULT NULL COMMENT 'Base Tax Before Discount',
  `tax_before_discount` decimal(7,2) DEFAULT NULL COMMENT 'Tax Before Discount',
  `ext_order_item_id` varchar(255) DEFAULT NULL COMMENT 'Ext Order Item ID',
  `locked_do_invoice` tinyint(1) DEFAULT NULL COMMENT 'Locked Do Invoice',
  `locked_do_ship` tinyint(1) DEFAULT NULL COMMENT 'Locked Do Ship',
  `price_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Price Incl Tax',
  `base_price_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Price Incl Tax',
  `row_total_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Row Total Incl Tax',
  `base_row_total_incl_tax` decimal(12,2) DEFAULT NULL COMMENT 'Base Row Total Incl Tax',
  `discount_tax_compensation_amount` decimal(7,2) DEFAULT NULL COMMENT 'Discount Tax Compensation Amount',
  `base_discount_tax_compensation_amount` decimal(7,2) DEFAULT NULL COMMENT 'Base Discount Tax Compensation Amount',
  `discount_tax_compensation_invoiced` decimal(7,2) DEFAULT NULL COMMENT 'Discount Tax Compensation Invoiced',
  `base_discount_tax_compensation_invoiced` decimal(7,2) DEFAULT NULL COMMENT 'Base Discount Tax Compensation Invoiced',
  `discount_tax_compensation_refunded` decimal(7,2) DEFAULT NULL COMMENT 'Discount Tax Compensation Refunded',
  `base_discount_tax_compensation_refunded` decimal(7,2) DEFAULT NULL COMMENT 'Base Discount Tax Compensation Refunded',
  `tax_canceled` decimal(7,2) DEFAULT NULL COMMENT 'Tax Canceled',
  `discount_tax_compensation_canceled` decimal(7,2) DEFAULT NULL COMMENT 'Discount Tax Compensation Canceled',
  `tax_refunded` decimal(7,2) DEFAULT NULL COMMENT 'Tax Refunded',
  `base_tax_refunded` decimal(7,2) DEFAULT NULL COMMENT 'Base Tax Refunded',
  `discount_refunded` decimal(7,2) DEFAULT NULL COMMENT 'Discount Refunded',
  `base_discount_refunded` decimal(7,2) DEFAULT NULL COMMENT 'Base Discount Refunded',
  `gift_message_id` int(11) DEFAULT NULL COMMENT 'Gift Message ID',
...
CREATE TABLE `sales_order_payment` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent ID',
  `base_shipping_captured` decimal(7,2) DEFAULT NULL COMMENT 'Base Shipping Captured',
  `shipping_captured` decimal(7,2) DEFAULT NULL COMMENT 'Shipping Captured',
  `amount_refunded` decimal(7,2) DEFAULT NULL COMMENT 'Amount Refunded',
  `base_amount_paid` decimal(12,2) DEFAULT NULL COMMENT 'Base Amount Paid',
  `amount_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Amount Canceled',
  `base_amount_authorized` decimal(12,2) DEFAULT NULL COMMENT 'Base Amount Authorized',
  `base_amount_paid_online` decimal(12,2) DEFAULT NULL COMMENT 'Base Amount Paid Online',
  `base_amount_refunded_online` decimal(12,2) DEFAULT NULL COMMENT 'Base Amount Refunded Online',
  `base_shipping_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Amount',
  `shipping_amount` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Amount',
  `amount_paid` decimal(12,2) DEFAULT NULL COMMENT 'Amount Paid',
  `amount_authorized` decimal(12,2) DEFAULT NULL COMMENT 'Amount Authorized',
  `base_amount_ordered` decimal(12,2) DEFAULT NULL COMMENT 'Base Amount Ordered',
  `base_shipping_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Shipping Refunded',
  `shipping_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Shipping Refunded',
  `base_amount_refunded` decimal(12,2) DEFAULT NULL COMMENT 'Base Amount Refunded',
  `amount_ordered` decimal(12,2) DEFAULT NULL COMMENT 'Amount Ordered',
  `base_amount_canceled` decimal(12,2) DEFAULT NULL COMMENT 'Base Amount Canceled',
...
CREATE TABLE `sales_order_status_state` (
  ...
  `visible_on_front` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Visible on front',
...
CREATE TABLE `sales_order_tax` (
  ...
  `position` int(11) NOT NULL COMMENT 'Position',
  `base_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Amount',
  `process` smallint(6) NOT NULL COMMENT 'Process',
  `base_real_amount` decimal(12,2) DEFAULT NULL COMMENT 'Base Real Amount',
  PRIMARY KEY (`tax_id`),
...
CREATE TABLE `sales_order_tax_item` (
  ...
  `tax_percent` decimal(5,2) NOT NULL COMMENT 'Real Tax Percent For Item',
  `amount` decimal(12,2) NOT NULL COMMENT 'Tax amount for the item and tax rate',
  `base_amount` decimal(12,2) NOT NULL COMMENT 'Base tax amount for the item and tax rate',
  `real_amount` decimal(12,2) NOT NULL COMMENT 'Real tax amount for the item and tax rate',
  `real_base_amount` decimal(12,2) NOT NULL COMMENT 'Real base tax amount for the item and tax rate',
...
CREATE TABLE `sales_payment_transaction` (
  ...
  `is_closed` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Is Closed',
  `additional_information` blob DEFAULT NULL COMMENT 'Additional Information',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Created At',
  PRIMARY KEY (`transaction_id`),
...
CREATE TABLE `sales_shipment` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store ID',
  `total_weight` decimal(8,2) DEFAULT NULL COMMENT 'Total Weight',
  `total_qty` decimal(8,2) DEFAULT NULL COMMENT 'Total Qty',
  `email_sent` tinyint(1) DEFAULT NULL COMMENT 'Email Sent',
  `send_email` tinyint(1) DEFAULT NULL COMMENT 'Send Email',
  `order_id` int(10) unsigned NOT NULL COMMENT 'Order ID',
  `customer_id` int(11) DEFAULT NULL COMMENT 'Customer ID',
...
CREATE TABLE `sales_shipment_item` (
  ...
  `row_total` decimal(12,2) DEFAULT NULL COMMENT 'Row Total',
  `price` decimal(7,2) DEFAULT NULL COMMENT 'Price',
  `weight` decimal(7,2) DEFAULT NULL COMMENT 'Weight',
  `qty` decimal(8,2) DEFAULT NULL COMMENT 'Qty',
  `product_id` int(11) DEFAULT NULL COMMENT 'Product ID',
  `order_item_id` int(11) DEFAULT NULL COMMENT 'Order Item ID',
  `additional_data` text DEFAULT NULL COMMENT 'Additional Data',
...
CREATE TABLE `search_query` (
  ...
  `store_id` smallint(5) unsigned NOT NULL DEFAULT 0 COMMENT 'Store ID',
  `display_in_terms` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Display in terms',
  `is_active` tinyint(1) DEFAULT 1 COMMENT 'Active status',
  `is_processed` tinyint(1) DEFAULT 0 COMMENT 'Processed status',
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'Updated at',
...
CREATE TABLE `theme` (
  ...
  KEY `index2` (`theme_path`,`area`) USING BTREE,
  KEY `THEME_THEME_PATH_AREA` (`theme_path`,`area`)
...
CREATE TABLE `url_rewrite` (
  ...
  KEY `dhgfhwrthhdfg` (`entity_id`,`entity_type`,`store_id`) USING BTREE
...
-- Dump completed on 2024-01-29 11:25:02
